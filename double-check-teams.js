module.exports = {	
	...
	'done_and_verified': [ 
		'umass-boston', 'wayne-state', 'niagara', 'mit', 
		'st-benedict', 'concordia-wi', 'st-scholastica', 
		'william-smith', 'marian', 'st-norbert', 'adrian', 'potsdam', 
		'stevenson','canton', 'morrisville', 'merrimack','syracuse','robert-morris', 
		'sacred-heart', 'clarkson','st-lawrence', 'cornell', 'princeton',
		'minnesota', 'north-dakota', 'ohio-state', 'st-cloud-state', 'bemidji-state',
		'mercyhurst', 'penn-state', 'lindenwood', 'rit',
		'quinnipiac', 'colgate', 'yale','rensselaer', 'harvard', 
		'wisconsin', 'brown', 'dartmouth', 'union', 'boston-college', 'northeastern', 
		'minnesota-duluth','boston-university','minnesota-state', 
		'new-hampshire', 'providence', 'connecticut',
		'vermont', 'merrimack', 'maine','endicott', 'northland', 'johnson-and-wales', 
		'lebanon-valley', 'becker', 'plattsburgh', 'salem-state', 'buffalo-state', 
		'utica', 'oswego', 'elmira','neumann', 'chatham', 'cortland', 'augsburg', 
		'concordia-mn', 'gustavus-adolphus','st-catherine', 'st-marys', 
		'st-thomas', 'hamline', 'st-olaf', 'bethel', 'lake-forest', 
		'finlandia', 'norwich', 'manhattanville', 'st-anselm','franklin-pierce', 
		'university-of-new-england', 'castleton', 'salve-regina', 'southern-maine', 
		'st-michaels', 'holy-cross', 'new-england-college', 'middlebury', 
		'connecticut-college', 'hamilton', 'trinity', 'amherst', 'bowdoin', 
		'williams', 'wesleyan', 'wisconsin-river-falls', 'st-cloud', 
		'wisconsin-stevens-point', 'wisconsin-superior', 'wisconsin-eau-claire', 
		'plymouth-state', 'nichols', 'colby', 
	],
	'todo': [
	],
	unknown: [],
